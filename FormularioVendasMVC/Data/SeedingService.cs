...
using FormularioVendasMVC.Models.Enums;

namespace FormularioVendasMVC.Data
{
    public class SeedingService
    {
        private FormularioVendasMVCContext _context;

        public SeedingService(FormularioVendasMVCContext context)
        {
            _context = context;
        }
        public void Seed()
        {
            ...
            SalesRecord r1 = new SalesRecord(1, new DateTime(2021, 07, 25), 11000.0, SaleStatus.Billed, s1);
            SalesRecord r2 = new SalesRecord(2, new DateTime(2021, 07, 4), 7000.0, SaleStatus.Billed, s5);
            SalesRecord r3 = new SalesRecord(3, new DateTime(2021, 07, 13), 4000.0, SaleStatus.Canceled, s4);
            SalesRecord r4 = new SalesRecord(4, new DateTime(2021, 07, 1), 8000.0, SaleStatus.Billed, s1);
            SalesRecord r5 = new SalesRecord(5, new DateTime(2021, 07, 21), 3000.0, SaleStatus.Billed, s3);
            SalesRecord r6 = new SalesRecord(6, new DateTime(2021, 07, 15), 2000.0, SaleStatus.Billed, s1);
            SalesRecord r7 = new SalesRecord(7, new DateTime(2021, 08, 28), 13000.0, SaleStatus.Billed, s2);
            SalesRecord r8 = new SalesRecord(8, new DateTime(2021, 08, 11), 4000.0, SaleStatus.Billed, s4);
            SalesRecord r9 = new SalesRecord(9, new DateTime(2021, 08, 14), 11000.0, SaleStatus.Pending, s6);
            SalesRecord r10 = new SalesRecord(10, new DateTime(2021, 08, 7), 9000.0, SaleStatus.Billed, s6);
            SalesRecord r11 = new SalesRecord(11, new DateTime(2021, 08, 13), 6000.0, SaleStatus.Billed, s2);
            ...
            SalesRecord r31 = new SalesRecord(12, new DateTime(2021, 10, 27), 4000.0, SaleStatus.Pending, s3);


            // Adicionando com o Entity Framework os registros
            ...
            // Salvando e confirmando as alterações.
